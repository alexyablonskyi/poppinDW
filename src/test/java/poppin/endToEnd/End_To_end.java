...
public class End_To_end extends Base {
	...
	Billing billing;
		...
		public void checkoutVisa() throws Exception {
			shipping.setShippingAddress(Values.NAME_FIRST, Values.NAME_LAST, Values.ID_EMAIL_QA_TEST, Values.PHONE_NUM, Values.ADDRESS, Values.ADDRESS2, "New Jersey", Values.LOC_NEWYORK, Values.ZIP_CODE_NY);
